...
if (isset($_POST["submit"])) {
    ...
    if (tambah3($_POST) > 0) {
        ...
        <script>
            alert('Data berhasil dimasukkan!');
            document.location.href = 'tambah_sewa.php';
        </script>
        ";
    }
}
                                ...
                                <div class="card-body text-white">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="harga_sewa" id="harga_sewa" onkeyup="sum();" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="alamat" id="alamat" onkeyup="sum();" required>
                                        </div>
                                        <div class="mb-3">
