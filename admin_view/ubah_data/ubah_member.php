...
$row = query("SELECT * FROM tb_anggota WHERE id = $id")[0];
...
if (isset($_POST["submit"])) {
    ...
    if (ubah($_POST) > 0) {
        ...
        <script>
            ...
            document.location.href = 'ubah_member.php';
        </script>
        ";
    }
...
<head>
    ...
    <title>Halaman Ubah Data Member</title>
    <style>
        label {
            display: block;
        }
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5 bg-transparent">
                                ...
                                <div class="card-body text-white">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="gambarLama" value="<?= $row['foto_ktp']; ?>">
                                        <div class="mb-3">
                                            <label for="nama" class="form-label">Nama</label>
                                            <input type="text" class="form-control" name="nama" for="nama" value="<?= $row['nama']; ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="tempat_tanggal_lahir" class="form-label">Tanggal Lahir</label>
                                            <input value="<?= $row['tempat_tanggal_lahir']; ?>" type="date" class="form-control" name="tempat_tanggal_lahir" for="tempat_tanggal_lahir">
                                        </div>
                                        <div class="mb-3">
                                            <label for="jenis_kelamin" class="form-label">Jenis Kelamin</label>
                                            <select class="form-select" type="text" class="form-control" name="jenis_kelamin" id="jenis_kelamin" aria-label="Default select example" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="email" for="email" value="<?= $row['email']; ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="no_hp" class="form-label">No. HP</label>
                                            <input type="text" class="form-control" name="no_hp" for="no_hp" value="<?= $row['no_hp']; ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="foto_ktp" class="form-label">Foto Member</label>
                                            <img src="../../img/<?= $row['foto_ktp']; ?>" width="100">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="akun" for="akun" value="<?= $row['akun']; ?>">
                                        </div>
