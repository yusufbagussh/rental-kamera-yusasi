            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="container bg-black">
                        <a class="btn btn-primary" href="../tambah_data/tambah_kamera.php" role="button">Tambahkan Data</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody class="text-white">
                                        ...
                                        $data = mysqli_query($conn, "SELECT * FROM tb_produk WHERE jenis_barang='1'");
                                        $jumlah_data = mysqli_num_rows($data);
                                        $total_halaman = ceil($jumlah_data / $batas);

                                        $rows = mysqli_query($conn, "SELECT * FROM tb_produk WHERE jenis_barang='1' LIMIT $halaman_awal, $batas");
                                        ...
                                        ?>
                                            ...
                                            <?php foreach ($rows as $row) : ?>
                                                <tr>
                                                    ...
                                                    <td class="aksi">
                                                        <a href="../hapus_data/hapus_kamera.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin??');" class="btn btn-outline-white">Hapus</a>
                                                        <a href="../ubah_data/ubah_kamera.php?id=<?= $row["id"]; ?>" class="btn btn-outline-white">Edit</a>
                                                    </td>
                                                </tr>
                                                <?php $i++; ?>
                                            <?php endforeach; ?>
                                ...
                                <nav>
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item">
                                            <a class="page-link text-black" <?php if ($halaman > 1) {
                                        ...
                                        ?>
                                            <li class="page-item"><a class="page-link text-black" href="?halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                                        <?php
                                        }
                                        ?>
                                        <li class="page-item">
                                            <a class="page-link text-black" <?php if ($halaman < $total_halaman) {
