...
<head>
    ...
    <title>Halaman Daftar Sewa</title>
</head>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="container bg-black">
                        <a class="btn btn-primary" href="../tambah_data/tambah_sewa.php" role="button">Tambahkan Data</a>
                                    ...
                                    <tbody class="text-white">
                                        ...
                                        <?php foreach ($rows as $row) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="../hapus_data/hapus_sewa.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin??');" class="btn btn-outline-white">Hapus</a>
                                                    <a href="../ubah_data/ubah_sewa.php?id=<?= $row["id"]; ?>" class="btn btn-outline-white">Edit</a>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
