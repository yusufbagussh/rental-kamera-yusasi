...
$rows = query("SELECT * FROM tb_produk WHERE jenis_barang='3'");
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Data Aksesoris Kamera</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="dashboard_admin.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Data Aksesoris Kamera</li>
                    </ol>
                    <div class="container bg-black">
                        <a class="btn btn-primary" href="../tambah_data/tambah_aksesoris.php" role="button">Tambahkan Data</a>
                        <a class="btn btn-primary" href="../../cetak_data/cetak_aksesoris.php" role="button" target="_blank">Cetak</a>
                    </div>
                    <br>
                    <!-- DataTales Example -->
                                    ...
                                    <tbody class="text-white">
                                        ...
                                        <?php foreach ($rows as $row) : ?>
                                            <tr>
                                                ...
                                                <td class="aksi">
                                                    <a href="../hapus_data/hapus_aksesoris.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin??');" class="btn btn-outline-white">Hapus</a>
                                                    <a href="../ubah_data/ubah_aksesoris.php?id=<?= $row["id"]; ?>" class="btn btn-outline-white">Edit</a>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
