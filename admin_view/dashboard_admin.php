<?php
session_start();
require '../session_user/session_dashboard_admin.php';
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link collapsed" href="daftar_data/data_kamera.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-camera"></i></div>Data Kamera
                            </a>
                            <a class="nav-link collapsed" href="daftar_data/data_hdcam.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-video"></i></div>Data Handycam
                            </a>
                            <a class="nav-link collapsed" href="daftar_data/data_aksesoris.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-microphone"></i></div>Data Aksesoris
                            </a>
                            <a class="nav-link collapsed" href="daftar_data/data_member.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-user-circle"></i></div>Data Member
                            </a>
                            <a class="nav-link collapsed" href="daftar_data/data_sewa.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-id-card-alt"></i></div>Data Sewa
                            </a>
                        </nav>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-6">
                            <div class="card bg-primary text-white mb-4">
                                <div class="card-body">Data Kamera</div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="daftar_data/data_kamera.php">View Details</a>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card bg-warning text-white mb-4">
                                <div class="card-body">Data Handycam</div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="daftar_data/data_hdcam.php">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="card bg-success text-white mb-4">
                                <div class="card-body">Data Aksesoris Kamera</div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="daftar_data/data_aksesoris.php">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="card bg-danger text-white mb-4">
                                <div class="card-body">Data Member</div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="daftar_data/data_member.php">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="card bg-info text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="daftar_data/data_sewa.php">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
